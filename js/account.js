const Account = {
  ...
  async show() {
    ...
    watchlaterView.innerHTML = `
      <div class="feed-title">👤 Account <button class="btn-secondary" onclick="Account.logout()" style="margin-left:auto; font-size:12px; padding:4px 12px">Sign out</button></div>
